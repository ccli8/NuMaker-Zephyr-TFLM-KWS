...
#if (LOG_LEVEL <= LOG_LEVEL_DEBUG)
#define APP_KWS_LOG_LEVEL LOG_LEVEL_DBG
#elif (LOG_LEVEL <= LOG_LEVEL_INFO)
#define APP_KWS_LOG_LEVEL LOG_LEVEL_INF
#elif (LOG_LEVEL <= LOG_LEVEL_WARN)
#define APP_KWS_LOG_LEVEL LOG_LEVEL_WRN
#elif (LOG_LEVEL <= LOG_LEVEL_ERROR)
#define APP_KWS_LOG_LEVEL LOG_LEVEL_ERR
#endif

#if defined(REGISTER_LOG_MODULE_APP_KWS)
LOG_MODULE_REGISTER(app_kws, APP_KWS_LOG_LEVEL);
#else
LOG_MODULE_DECLARE(app_kws, APP_KWS_LOG_LEVEL);
#endif
